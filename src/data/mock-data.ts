...
export const orderItems: OrderItem[] = [
  ...
  {
    id: "a222a222-a222-a222-a222-a222a222a222",
    name: "연어 큐브 져키 (DOG)",
    quantity: 1,
    price: 10000,
    image: "/placeholder.svg?height=64&width=64",
...
export const mockWrittenReviews: WrittenReview[] = [
  {
    ...
    reviewText:
      "3분 카레보다 약간 비싸데 큰 차이점은 없어서 조금 아쉽긴했지만 괜찮았습니다",
    isEditable: true,
  },
  {
    id: "2",
    ...
    reviewText:
      "면도가 정말 깔끔하게 잘 됩니다. 여분날도 함께 있어서 오래 사용할 수 있을 것 같아요.",
    summary: "면도 깔끔하고 좋아요",
    isEditable: true,
  },
  {
    ...
    reviewText:
      "효과는 있는 것 같은데 생각보다 자극적이네요. 민감한 피부에는 조금 부담스러울 수 있어요.",
    isEditable: true,
  },
  {
    id: "4",

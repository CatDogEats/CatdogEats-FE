// src/components/OrderPayment/components/ShippingInformationForm.tsx
"use client";
...
} from "./AddressSearchDialog";
import AddressSearchField from "./AddressSearchField";
import type { ShippingInformationFormProps } from "../types/orderPayment.types";
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12 }}>
              <TextField
                ...
                onChange={(e) =>
                  onShippingInfoChange("fullName", e.target.value)
                }
            ...
            <Grid size={{ xs: 12 }}>
              <TextField
                ...
                onChange={(e) =>
                  onShippingInfoChange("phoneNumber", e.target.value)
                }

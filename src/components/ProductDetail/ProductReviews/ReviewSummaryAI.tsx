...
const ReviewSummaryAI: React.FC<ReviewSummaryAIProps> = ({ reviewSummary, totalReviews }) => {
                        ...
                        <CardContent sx={{ p: 0 }}>
                            ...
                            <TabPanel value={selectedTab} index={0}>
                                <Box sx={{ p: 3 }}>
                                    ...
                                    <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5, mb: 3 }}>
                                        {reviewSummary.positiveMainPoints.map((point, index) => (
                                    ...
                                    <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                                        {reviewSummary.positiveKeywords.map((keyword, index) => (
                                            <Chip
                                                key={index}
                                                label={keyword}
                                                size="small"
                            ...
                            <TabPanel value={selectedTab} index={1}>
                                <Box sx={{ p: 3 }}>
                                    ...
                                    <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5, mb: 3 }}>
                                        {reviewSummary.negativeMainPoints.map((point, index) => (
                                            <Box key={index} sx={{ display: "flex", alignItems: "flex-start", gap: 1 }}>
                                                <Box
                                                    sx={{
                                                        width: 6,
                                    ...
                                    <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                                        {reviewSummary.negativeKeywords.map((keyword, index) => (
                                            <Chip
                                                key={index}
                                                label={keyword}
                                                size="small"
